...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Deriv Pulse · AI Intelligence Terminal" },
      { name: "description", content: "Real-time digit analytics and tick stream analysis for Deriv synthetic indices, forex, and crypto." },
      { property: "og:title", content: "Deriv Pulse · AI Intelligence Terminal" },
      { property: "og:description", content: "Institutional-grade real-time digit analytics for Deriv markets." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "author", content: "Deriv Pulse — Proprietary Software. All rights reserved." },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" },
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300;400;500;600;700&family=JetBrains+Mono:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400&family=Inter:wght@300;400;500;600&display=swap" },
    ],
  }),
